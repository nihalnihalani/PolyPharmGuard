...
| 06 | 0:30–0:42 | Patient queue | `/batch` page. Mr. Patel row at top, 81 CRITICAL. Cursor moves to his Review button | "Meet Mr. Patel. Sixty-eight, on fluvoxamine, tizanidine, clopidogrel." | DEMO DATA: requires Mr. Patel synthea bundle (Agent 3 in flight) |
| 07 | 0:42–0:55 | Pairwise vs PolyPharmGuard | `/review/mr-patel`. Risk gauge spins to 81. Side-by-side overlay: "Pairwise: 0 critical" vs "PolyPharmGuard: 4 cited findings" | "Every pairwise checker passed him. Ours didn't." | THE AI FACTOR money shot. Hold 3+ sec |
...
| 09 | 1:10–1:20 | Synergistic risk | Continue expanding chain. Steps 3 & 4 visible with ritonavir + clopidogrel | "Residual ritonavir blocking CYP3A4, plus clopidogrel competing for what's left — synergistic risk." | Linger on the FDA citation tag |
| 10 | 1:20–1:28 | Risk gauge zoom | Zoom into composite risk gauge. Subtitle reveals named factors | "Composite risk index" | Use Premiere/FCP zoom keyframe — no in-app animation |
| 11 | 1:28–1:32 | Cytoscape graph | Drug interaction graph: 4 colored edges between nodes | "Drug interaction graph" | Wait for layout to settle before recording |
...
| 14 | 1:50–2:00 | Pharmacist queue | `/batch` again. All three patients ranked by 90-day risk | "Pharmacists triage by risk, not by alphabet." | Cursor highlights the risk badge column |
